...
public class TrelloClientTest {
    ...
    public void init() {
        ...
        when(trelloConfig.getTrelloUsername()).thenReturn("jacobanna1");
    }
    ...
    public void shouldFetchTrelloBoards() throws URISyntaxException {
        ...
        trelloBoardDtos[0] = new TrelloBoardDto("test_name", "test_id", new ArrayList<>());
        URI uri = new URI("http://test.com/members/jacobanna1/boards?key=test&token=test&fields=name,id&lists=all");
